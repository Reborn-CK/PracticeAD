...
from ...core.components import HealthComponent, DefenseComponent
from ...core.pipeline import Pipeline, EffectExecutionContext

# --- 导入新的处理器 ---
from .damage_processors import CritHandler, DefenseHandler, ResistanceHandler, LifestealHandler, ThornsHandler
...
class CombatResolutionSystem:
    def __init__(self, event_bus: EventBus, data_manager: 'DataManager' = None, passive_system: 'PassiveAbilitySystem' = None):
